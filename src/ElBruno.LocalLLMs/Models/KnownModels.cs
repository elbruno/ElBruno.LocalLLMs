...
public static class KnownModels
{
    ...
    public static readonly ModelDefinition Phi35MiniInstruct = new()
    {
        ...
        RequiredFiles = ["gpu/gpu-int4-awq-block-128/*"],
        ModelSubPath = "gpu/gpu-int4-awq-block-128",
        ModelType = OnnxModelType.GenAI,
    ...
    public static readonly ModelDefinition Phi4 = new()
    {
        ...
        RequiredFiles = ["gpu/gpu-int4-rtn-block-32/*"],
        ModelSubPath = "gpu/gpu-int4-rtn-block-32",
        ModelType = OnnxModelType.GenAI,
        ChatTemplate = ChatTemplateFormat.Phi3,
        Tier = ModelTier.Medium,
        HasNativeOnnx = true,
    ...
    /// Published ONNX target is elbruno/Fara1.5-9B-onnx, but current ORT-GenAI 0.14.1 builder
    /// support is incomplete: it exports the decoder-only path for Fara's Qwen3.5-VL architecture.
